...
var path = window.location.pathname.includes('outfit') ? 'outfits' : 'items';
...
function addAllItems() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    if (path == 'items') {
      ...
      var year = (0, _moment2.default)(date, 'YYYY-MM-DD');
      el.classList.add(year.format('YYYY'));
    }
...
function staggerImageLoad() {
  ...
  (0, _imagesloaded2.default)(group, function () {
...
function openSubpage(e) {
  ...
  document.title = name;
  _jquery2.default.get(url, null, function (data) {
    var body = (0, _jquery2.default)(data).find('#subpage-wrapper').html();
    sp.innerHTML = body;
    (0, _imagesloaded2.default)('.subpage__grid', function () {
      initializeIsotope('.subpage__grid');
    });
...
/***/ 0:
/*!***********************************!*\
  !*** multi ./source/js/global.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/vita/Documents/my projects/closet/source/js/global.js */"./source/js/global.js");
